...
# Adaptive OU feedback thresholds
adaptive_cfg = config.get("adaptive_ou", {})
entropy_low = adaptive_cfg.get("entropy_low", 2.0)
entropy_high = adaptive_cfg.get("entropy_high", 5.0)
...
for _ in range(max_new_tokens):
    # Adaptive OU: entropy feedback, no KL
...
with open(os.path.join(save_dir, "ou_adaptive_metrics.json"), "w") as f:
